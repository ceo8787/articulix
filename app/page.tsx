...
import { Gift, Package, Store, RefreshCw, AlertTriangle, TrendingDown } from 'lucide-react'
...
export default function Dashboard() {
  const [stats, setStats] = useState<Stats>({ totalModels: 0, urgentModels: 0, lowModels: 0, totalVenues: 0, pendingReorders: 0, totalFigurines: 0 })
